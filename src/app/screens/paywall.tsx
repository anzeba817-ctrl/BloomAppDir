  ...
  const plans = [
    {
      ...
      features: [
        { text: t("feature_limit_3"), included: true, isNegative: false, isBonus: false },
        { text: t("feature_basic_states"), included: true, isNegative: false, isBonus: false },
        { text: t("feature_sunny_classic"), included: true, isNegative: false, isBonus: false },
        { text: t("feature_basic_stats"), included: true, isNegative: false, isBonus: false },
        { text: t("feature_fixed_cadence"), included: true, isNegative: false, isBonus: false },
        { text: t("feature_ads_present"), included: true, isNegative: true, isBonus: false },
      ],
    ...
    },
    {
      ...
      recommended: true,
      features: [
        { text: t("feature_unlimited_habits"), included: true, isNegative: false, isBonus: false },
        { text: t("feature_7_states"), included: true, isNegative: false, isBonus: false },
        { text: t("feature_all_widgets"), included: true, isNegative: false, isBonus: false },
        { text: t("feature_full_heatmap"), included: true, isNegative: false, isBonus: false },
        { text: t("feature_custom_cadence"), included: true, isNegative: false, isBonus: false },
        { text: t("feature_no_ads"), included: true, isNegative: false, isBonus: false },
        { text: t("feature_3_crystals"), included: true, isNegative: false, isBonus: true },
      ],
    ...
    },
    {
      ...
      features: [
        { text: t("feature_all_bloom"), included: true, isNegative: false, isBonus: false },
        { text: t("feature_multiplier"), included: true, isNegative: false, isBonus: true },
        { text: t("feature_skin_legend"), included: true, isNegative: false, isBonus: true },
        { text: t("feature_founder_badge"), included: true, isNegative: false, isBonus: true },
        { text: t("feature_lifetime"), included: true, isNegative: false, isBonus: false },
      ],
